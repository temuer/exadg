...
namespace ExaDG
{
  ...
  RHSOperator<dim, Number, n_components>::RHSOperator()
    : matrix_free(nullptr)
    , time(0.0)
  {}
  ...
  template <int dim, typename Number, int n_components>
  void
  RHSOperator<dim, Number, n_components>::evaluate(
    VectorType  &dst,
  ...
  template <int dim, typename Number, int n_components>
  void
  RHSOperator<dim, Number, n_components>::evaluate_add(
    VectorType  &dst,
    double const evaluation_time) const
  {
  ...
  template <int dim, typename Number, int n_components>
  void
  RHSOperator<dim, Number, n_components>::do_cell_integral(
