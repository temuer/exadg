...
namespace ExaDG
{
  namespace CompNS
  {
    ...
    public:
      ...
      void
      get_wall_times(std::vector<std::string> &name,
    ...
    private:
      ...
      std::shared_ptr<ExplicitTimeIntegrator<Operator, VectorType>>
        rk_time_integrator;
      ...
      // monitor the L2-norm of the solution vector in order to detect
      // instabilities
