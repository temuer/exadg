...
namespace ExaDG
{
  namespace Structure
  {
    ...
    void
    LinearOperator<dim, Number>::do_cell_integral(
      ...
      for (unsigned int q = 0; q < integrator.n_q_points; ++q)
        {
          ...
          tensor const sigma = material->second_piola_kirchhoff_stress(
            integrator.get_gradient(q), integrator.get_current_cell_index(), q);
