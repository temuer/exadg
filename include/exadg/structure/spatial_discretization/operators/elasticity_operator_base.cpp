...
namespace ExaDG
{
  namespace Structure
  {
    ...
    template <int dim, typename Number>
    IntegratorFlags
    ElasticityOperatorBase<dim, Number>::get_integrator_flags(
      bool const unsteady) const
    {
      IntegratorFlags flags;

      auto const unsteady_flag = unsteady ? dealii::EvaluationFlags::values :
    ...
    template <int dim, typename Number>
    double
    ElasticityOperatorBase<dim, Number>::get_scaling_factor_mass_operator()
      const
    {
    ...
    template <int dim, typename Number>
    void
    ElasticityOperatorBase<dim, Number>::set_inhomogeneous_boundary_values(
    ...
    template <int dim, typename Number>
    void
    ElasticityOperatorBase<dim, Number>::reinit_cell_derived(
