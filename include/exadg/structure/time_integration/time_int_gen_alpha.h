...
namespace ExaDG
{
  namespace Structure
  {
    ...
    public:
      ...
      /*
       * This function needs to be called before the first time step is
       * performed. In case of a restart, the vector acceleration_n is read from
       * restart files and nothing has to be done here.
       */
      void
      ...
      /**
       * This function is for coupled multi-physics problems applying
       * partitioned solution algorithms. Set use_extrapolation = true in the
       * first iteration of the partitioned scheme within each time step.
       */
      void
