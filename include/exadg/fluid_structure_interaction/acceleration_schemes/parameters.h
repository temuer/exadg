...
namespace ExaDG
{
  namespace FSI
  {
    ...
    // The initial guess used in the FSI coupling loop is computed using an
    // extrapolation of suitable order (defined within the single-field time
    // integrators) or the last iterate from the previous time step.
    ...
    struct Parameters
    {
      ...
      add_parameters(dealii::ParameterHandler &prm,
                     std::string const        &subsection_name = "FSI")
      {
