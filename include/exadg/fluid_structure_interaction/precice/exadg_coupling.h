...
namespace ExaDG
{
  ...
  {
    /**
     * Derived class of the CouplingBase: shallow wrapper around the preCICE API
     * functions, where the participant defines a vector of points and the
     * interface class here handles the data exchange with preCICE, i.e.,
     * defining a coupling mesh and passing data to preCICE.
     */
