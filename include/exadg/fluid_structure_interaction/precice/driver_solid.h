    ...
    namespace preCICE
    {
      ...
      public:
        ...
        setup_structure()
        {
          ...
          structure->setup(this->application->structure,
                           this->mpi_comm,
                           this->is_test);

          this->timer_tree.insert({"FSI", "Setup", "Structure"},
        ...
        setup_interface_coupling()
        {
          ...
          structure->pde_operator->initialize_dof_vector(
        ...
        solve() const final
        {
          ...
          while (this->precice->is_coupling_ongoing())
            {
              structure->time_integrator->advance_one_timestep_pre_solve(
                is_new_time_window);
              ...
              structure->time_integrator
                ->advance_one_timestep_partitioned_solve(is_new_time_window);
              ...
              coupling_structure_to_fluid(
                structure->time_integrator->get_velocity_np(),
                structure->time_integrator->get_time_step_size());

              // TODO: Add synchronization for the time-step size here. For now,
              // we only allow a constant time-step size
        ...
        print_performance_results(double const total_time) const override
        {
          ...
          unsigned int N_time_steps =
            structure->time_integrator->get_number_of_time_steps();
