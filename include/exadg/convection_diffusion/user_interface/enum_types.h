...
namespace ExaDG
{
  namespace ConvDiff
  {
     ...
     * solved, i.e., diffusion problem, convective problem or
    ...
    /*
     * This parameter describes the type of velocity field for the convective
     * term. Function means that an analytical velocity field is prescribed,
     * while DoFVector means that the velocity field is read and interpolated
     * from a DoFVector, e.g., the velocity field obtained as the solution of
