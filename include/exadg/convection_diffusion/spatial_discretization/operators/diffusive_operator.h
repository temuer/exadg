  ...
  namespace ConvDiff
  {
    namespace Operators
    {
      ...
      public:
         ...
         * numerical flux since the flux is multiplied by the normal vector,
         * i.e., "gradient_flux" = numerical_flux * normal, where normal denotes
