...
namespace ExaDG
{
  namespace ConvDiff
  {
    ...
    private:
      ...
      std::shared_ptr<
        ExplicitTimeIntegrator<OperatorExplRK<Number>, VectorType>>
        rk_time_integrator;
      ...
      // store time step size according to diffusion condition so that it does
      // not have to be recomputed in case of adaptive time stepping
