...
namespace ExaDG
{
  ...
  public:
    ...
    typedef dealii::LinearAlgebra::distributed::Vector<
      typename Preconditioner::MultigridNumber>
      VectorTypeMG;
    ...
    check()
    {
      ...
      VectorType solution_after_mg_cylce(initial_solution),
      ...
      preconditioner->apply_smoother_on_fine_level(solution_after_smoothing,
                                                   tmp_float);
                 ...
                 VectorTypeMG const &solution_after_smoothing) const
    {
      ...
      data_out.build_patches(underlying_operator.get_matrix_free()
      ...
      filename << name << "_Proc"
               << dealii::Utilities::MPI::this_mpi_process(mpi_comm) << ".vtu";
