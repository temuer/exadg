...
namespace ExaDG
{
  ...
  /**
   * Certain functionality of e.g. Trilinos is only available in double
   * precision. The aim of this function is to hide this circumstance from the
   * user code (that uses the template parameter Number) and to perform Number
   * -> double conversions and then call the double-version of a certain
