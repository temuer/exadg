...
namespace ExaDG
{
  ...
  public:
    typedef dealii::PreconditionChebyshev<Operator,
                                          VectorType,
                                          JacobiPreconditioner<Operator>>
      ChebyshevPointJacobi;
    typedef dealii::PreconditionChebyshev<Operator,
                                          VectorType,
                                          BlockJacobiPreconditioner<Operator>>
      ChebyshevBlockJacobi;
    typedef dealii::PreconditionChebyshev<
      Operator,
      VectorType,
      AdditiveSchwarzPreconditioner<Operator>>
      ...
      if (data.preconditioner == PreconditionerSmoother::PointJacobi)
        {
          ...
          chebyshev_point_jacobi->initialize(*underlying_operator,
                                             additional_data_point);
        }
      else if (data.preconditioner == PreconditionerSmoother::BlockJacobi)
        {
          preconditioner_block_jacobi->update();
          chebyshev_block_jacobi->initialize(*underlying_operator,
                                             additional_data_block);
        }
      else if (data.preconditioner == PreconditionerSmoother::AdditiveSchwarz)
        {
          preconditioner_additive_schwarz->update();
          chebyshev_additive_schwarz->initialize(
            *underlying_operator, additional_data_additive_schwarz);
        }
      else
        {
          AssertThrow(false, dealii::ExcNotImplemented());
      ...
      if (data.preconditioner == PreconditionerSmoother::PointJacobi)
        {
          preconditioner_point_jacobi =
            std::make_shared<JacobiPreconditioner<Operator>>(
          ...
          additional_data_point.eig_cg_n_iterations =
            data.iterations_eigenvalue_estimation;
      ...
      else if (data.preconditioner == PreconditionerSmoother::BlockJacobi)
        {
          preconditioner_block_jacobi =
            std::make_shared<BlockJacobiPreconditioner<Operator>>(
              *underlying_operator, initialize_preconditioner);
          ...
          additional_data_block.eig_cg_n_iterations =
            data.iterations_eigenvalue_estimation;
      ...
      else if (data.preconditioner == PreconditionerSmoother::AdditiveSchwarz)
        {
          preconditioner_additive_schwarz =
            std::make_shared<AdditiveSchwarzPreconditioner<Operator>>(
              *underlying_operator, initialize_preconditioner);

          additional_data_additive_schwarz.preconditioner =
            preconditioner_additive_schwarz;
          additional_data_additive_schwarz.smoothing_range =
            data.smoothing_range;
          additional_data_additive_schwarz.degree = data.degree;
          additional_data_additive_schwarz.eig_cg_n_iterations =
            data.iterations_eigenvalue_estimation;

          chebyshev_additive_schwarz =
            std::make_shared<ChebyshevAdditiveSchwarz>();
  ...
  private:
    ...
    std::shared_ptr<BlockJacobiPreconditioner<Operator>>
      preconditioner_block_jacobi;
    std::shared_ptr<AdditiveSchwarzPreconditioner<Operator>>
      preconditioner_additive_schwarz;
    ...
    typename ChebyshevAdditiveSchwarz::AdditionalData
