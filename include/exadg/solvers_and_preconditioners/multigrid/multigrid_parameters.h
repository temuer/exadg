...
namespace ExaDG
{
  ...
  struct AMGData
  {
    AMGData()
    {
      ...
      boomer_data.relaxation_type_down = dealii::PETScWrappers::
        PreconditionBoomerAMG::AdditionalData::RelaxationType::Chebyshev;
      boomer_data.relaxation_type_up = dealii::PETScWrappers::
        PreconditionBoomerAMG::AdditionalData::RelaxationType::Chebyshev;
      boomer_data.relaxation_type_coarse = dealii::PETScWrappers::
        PreconditionBoomerAMG::AdditionalData::RelaxationType::Chebyshev;
#endif
    };
  ...
  struct SmootherData
  {
      ...
      if (smoother == MultigridSmoother::Chebyshev)
        {
          ...
          print_parameter(pcout,
                          "Iterations eigenvalue estimation",
                          iterations_eigenvalue_estimation);
        }
    }
    ...
    // Chebyshev smmother: sets the smoothing range (range of eigenvalues to be
    // smoothed)
