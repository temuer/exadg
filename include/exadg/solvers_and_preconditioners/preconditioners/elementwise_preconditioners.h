...
namespace ExaDG
{
  namespace Elementwise
  {
    ...
    /**
     * This class implements an identity preconditioner for iterative solvers
     * for elementwise problems.
     */
    template <typename Number>
    ...
    /**
     * This class implements a Jacobi preconditioner for iterative solvers for
     * elementwise problems.
     */
    ...
    public:
      ...
      {
        integrator =
          std::make_shared<Integrator>(matrix_free, dof_index, quad_index);
    ...
    private:
      ...
      dealii::LinearAlgebra::distributed::Vector<Number>
        global_inverse_diagonal;
    };

    /**
     * This class implements an elementwise inverse mass preconditioner.
     * Currently, this class can only be used if the inverse mass can be
     * realized as a matrix-free operator evaluation available via utility
     * functions in deal.II.
     */
    ...
    public:
      ...
      // use a template parameter of -1 to select the precompiled version of
      // this operator
        ...
        unsigned int const                     quad_index)
      {
        ...
        // The inverse mass preconditioner is only available for discontinuous
        ...
        // evaluation is only available in deal.II for tensor-product elements.
        AssertThrow(
        ...
        // n_nodes_1d.
        AssertThrow(
          matrix_free.get_shape_info(0, quad_index).data[0].n_q_points_1d ==
            fe.degree + 1,
          dealii::ExcMessage(
      ...
      update() final
      {
        // no updates needed as long as the MatrixFree/Integrator object is
