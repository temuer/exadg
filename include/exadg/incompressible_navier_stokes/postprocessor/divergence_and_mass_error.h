...
namespace ExaDG
{
  namespace IncNS
  {
    struct MassConservationData
    {
      ...
      void
      print(dealii::ConditionalOStream &pcout, bool const unsteady)
      {
    ...
    private:
      /*
       *  This function calculates the divergence error and the error of mass
       * flux over interior element faces.
       *
