...
namespace ExaDG
{
  namespace IncNS
  {
     ...
     * and one spatial, homogeneous direction (averaging_direction = {0,1,2}),
     * e.g., in the x-direction with a line in the y-z plane.
     *
     * NOTE: This functionality can only be used for hypercube meshes and for
     * geometries/meshes for which the cells are aligned with the coordinate
     * axis.
     */
    ...
    private:
      ...
      // For all lines: for all points along the line: list of all relevant
      // cells and points in ref coordinates
      ...
      // For all lines: for pressure reference point: list of all relevant cells
      // and points in ref coordinates
