  ...
  namespace IncNS
  {
    namespace Precursor
    {
      ...
      public:
          ...
          std::vector<std::string> const                  &subsection_names)
        {
          ...
          this->param.grid.n_refine_global =
            this->resolution_parameters.refine_space;
      ...
      public:
        ...
        /**
         * Precursor and main domain. Make sure to create these objects in the
         * constructor of a derived class implementing a concrete precursor
         * application with non-abstract precursor domain and main domain.
         */
      ...
      protected:
        ...
        // This parameter allows to switch off the precursor (e.g. to test a
        // simplified setup without precursor and prescribed boundary conditions
        // or inflow data). The default value is false, i.e. to simulate with
        // precursor. Set this variable to true in a derived class in order to
        // switch off the precursor.
