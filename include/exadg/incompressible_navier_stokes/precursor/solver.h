...
namespace ExaDG
{
  ...
  create_input_file(std::string const &input_file)
  {
    ...
    IncNS::Precursor::get_application<Dim, Number>(input_file, MPI_COMM_WORLD)
      ->add_parameters(prm);
