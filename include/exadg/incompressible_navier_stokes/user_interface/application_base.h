...
namespace ExaDG
{
  namespace IncNS
  {
    ...
    public:
      ...
      {
        // Note that the grid parameters in Poisson::Parameters are ignored
        // since the grid is created using the parameters specified in
        // IncNS::Parameters
        ...
        AssertThrow(
          poisson_param.right_hand_side == false,
          dealii::ExcMessage(
