...
namespace ExaDG
{
  namespace IncNS
  {
    ...
    /*
     * Base class for projection-type incompressible Navier-Stokes solvers such
     * as the high-order dual splitting (velocity-correction) scheme or pressure
     * correction schemes.
     */
    template <int dim, typename Number>
    ...
    protected:
      /*
       * Calls setup() function of base class and additionally initializes the
       * pressure Poisson operator needed for projection-type methods.
       */
      void
    ...
    public:
      ...
      /*
       * Pressure Poisson equation: This function evaluates the inhomogeneous
       * parts of boundary face integrals of the negative Laplace operator and
       * adds the result to the dst-vector.
       */
      void
      do_rhs_ppe_laplace_add(VectorType &dst, double const &time) const;

      /*
       * This function solves the pressure Poisson equation and returns the
      ...
      /*
       * This function applies the projection operator (used for throughput
       * measurements).
       */
      void
      ...
      /*
       * This function applies the Laplace operator (used for throughput
       * measurements).
       */
      void
      ...
      /*
       * This function evaluates the rhs-contribution of the viscous term and
       * adds the result to the dst-vector.
       */
      void
      ...
      /*
       * This function evaluates the rhs-contribution of the convective term and
       * adds the result to the dst-vector. This functions is only used for a
       * "linearly implicit formulation" of the convective term.
       */
      void
