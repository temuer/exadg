...
namespace ExaDG
{
  ...
  {
    /*
     *  Combined divergence and continuity penalty operator: applies the
     * operation
     *
     *   mass operator + dt * divergence penalty operator + dt * continuity
     * penalty operator .
     *
     *  In detail
     *
     ...
     *
     *    Continuity penalty operator: ( v_h , tau_conti * jump(u_h) )_dOmega^e,
     * where
     *
