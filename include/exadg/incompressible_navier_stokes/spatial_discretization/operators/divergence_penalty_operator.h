          ...
          for (unsigned int cell = 0; cell < n_cells; ++cell)
            {
              ...
              if (data.type_penalty_parameter ==
                    ...
                    TypePenaltyParameter::ViscousAndConvectiveTerms)
                {
                  ...
                  scalar h =
                    calculate_characteristic_element_length(volume,
                                                            dim,
                                                            element_type);
                  scalar h_eff =
