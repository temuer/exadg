...
namespace ExaDG
{
  namespace IncNS
  {
    ...
    template <int dim, typename Number>
    void
    DivergenceOperator<dim, Number>::apply(VectorType       &dst,
    ...
    template <int dim, typename Number>
    void
    DivergenceOperator<dim, Number>::apply_add(VectorType       &dst,
                                               VectorType const &src) const
    {
      matrix_free->loop(&This::cell_loop,
                        &This::face_loop,
    ...
    template <int dim, typename Number>
    void
    DivergenceOperator<dim, Number>::rhs(VectorType  &dst,
    ...
    template <int dim, typename Number>
    void
    DivergenceOperator<dim, Number>::rhs_bc_from_dof_vector(
      VectorType       &dst,
    ...
    template <int dim, typename Number>
    void
    DivergenceOperator<dim, Number>::rhs_add(VectorType  &dst,
                                             Number const evaluation_time) const
    {
    ...
    template <int dim, typename Number>
    void
    DivergenceOperator<dim, Number>::evaluate(
      VectorType       &dst,
    ...
    template <int dim, typename Number>
    void
    DivergenceOperator<dim, Number>::evaluate_add(
      VectorType       &dst,
      VectorType const &src,
      Number const      evaluation_time) const
    {
    ...
    template <int dim, typename Number>
    void
    DivergenceOperator<dim, Number>::do_cell_integral_weak(
    ...
    template <int dim, typename Number>
    void
    DivergenceOperator<dim, Number>::do_cell_integral_strong(
      CellIntegratorP &pressure,
      CellIntegratorU &velocity) const
    {
      for (unsigned int q = 0; q < velocity.n_q_points; ++q)
    ...
    template <int dim, typename Number>
    void
    DivergenceOperator<dim, Number>::do_face_integral(
          ...
          if (data.formulation == FormulationVelocityDivergenceTerm::Weak)
            {
              ...
              pressure_p.submit_value(-flux_times_normal, q);
                   ...
                   FormulationVelocityDivergenceTerm::Strong)
            {
           ...
           ++cell)
        {
          ...
          if (data.integration_by_parts == true and
              data.formulation == FormulationVelocityDivergenceTerm::Weak)
            {
              ...
              pressure.integrate_scatter(dealii::EvaluationFlags::gradients,
                                         dst);
            }
      ...
      if (data.integration_by_parts == true)
        {
          ...
          for (unsigned int face = face_range.first; face < face_range.second;
               face++)
            {
              ...
              pressure_m.integrate_scatter(dealii::EvaluationFlags::values,
                                           dst);
              pressure_p.integrate_scatter(dealii::EvaluationFlags::values,
                                           dst);
            }
        }
    }
      ...
      if (data.integration_by_parts == true and data.use_boundary_data == true)
        {
          FaceIntegratorU velocity(matrix_free,
                                   ...
                                   data.dof_index_velocity,
                                   data.quad_index);
          FaceIntegratorU velocity_ext(matrix_free,
                                       true,
                                       data.dof_index_velocity,
                                       data.quad_index);
          FaceIntegratorP pressure(matrix_free,
          ...
          for (unsigned int face = face_range.first; face < face_range.second;
               face++)
            {
              ...
              velocity_ext.gather_evaluate(*velocity_bc,
