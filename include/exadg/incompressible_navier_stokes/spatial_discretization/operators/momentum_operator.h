...
namespace ExaDG
{
  namespace IncNS
  {
    ...
    public:
      ...
      /**
       * This function creates own kernels for the different terms of the
       * combined PDE operator. This function is typically called when using
       * this operator as the PDE operator in multigrid.
       */
      void
