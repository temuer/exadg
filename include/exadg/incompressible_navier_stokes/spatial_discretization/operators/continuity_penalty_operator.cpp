...
namespace ExaDG
{
  namespace IncNS
  {
    ...
    template <int dim, typename Number>
    void
    ContinuityPenaltyOperator<dim, Number>::apply(VectorType       &dst,
    ...
    template <int dim, typename Number>
    void
    ContinuityPenaltyOperator<dim, Number>::apply_add(
      VectorType       &dst,
      VectorType const &src) const
    {
      matrix_free->loop(
    ...
    template <int dim, typename Number>
    void
    ContinuityPenaltyOperator<dim, Number>::rhs(
      VectorType  &dst,
    ...
    template <int dim, typename Number>
    void
    ContinuityPenaltyOperator<dim, Number>::rhs_add(
      VectorType  &dst,
      Number const evaluation_time) const
    {
    ...
    template <int dim, typename Number>
    void
    ContinuityPenaltyOperator<dim, Number>::evaluate(
      VectorType       &dst,
    ...
    template <int dim, typename Number>
    void
    ContinuityPenaltyOperator<dim, Number>::evaluate_add(
      VectorType       &dst,
      VectorType const &src,
      Number const      evaluation_time) const
    {
      ...
      if (data.use_boundary_data)
        {
          ...
          for (unsigned int face = face_range.first; face < face_range.second;
               face++)
            {
              ...
              integrator_m.integrate_scatter(dealii::EvaluationFlags::values,
                                             dst);
            }
        }
    }
    ...
    template <int dim, typename Number>
    void
    ContinuityPenaltyOperator<dim, Number>::do_face_integral(
