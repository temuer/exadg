  ...
  namespace IncNS
  {
    namespace Operators
    {
      ...
      public:
        ...
        /*
         *  This function implements the central flux as numerical flux
         * function.
         */
        ...
        inline DEAL_II_ALWAYS_INLINE //
          scalar
          get_volume_flux_weak(CellIntegratorP   &pressure,
        ...
        /*
         * Volume flux, i.e., the term occurring in the volume integral for
         * strong formulation (no integration-by-parts, or integration-by-parts
         * performed twice)
         */
        inline DEAL_II_ALWAYS_INLINE //
          vector
          get_volume_flux_strong(CellIntegratorP   &pressure,
                                 unsigned int const q) const
        {
    ...
    public:
      ...
      void
      rhs_bc_from_dof_vector(VectorType       &dst,
    ...
    private:
      void
      do_cell_integral_weak(CellIntegratorP &pressure,
                            CellIntegratorU &velocity) const;

      void
      do_cell_integral_strong(CellIntegratorP &pressure,
                              CellIntegratorU &velocity) const;
      ...
      // to make sure that we also apply the correct boundary conditions for
      // p^*, i.e., g_p^* = 1/scaling_factor * g_p
      double inverse_scaling_factor_pressure;

      Operators::GradientKernel<dim, Number> kernel;

      // needed if pressure Dirichlet boundary condition is evaluated from dof
      // vector
