...
namespace ExaDG
{
  namespace IncNS
  {
    ...
    template <int dim, typename Number>
    void
    GradientOperator<dim, Number>::initialize(
    ...
    template <int dim, typename Number>
    void
    GradientOperator<dim, Number>::set_scaling_factor_pressure(
    ...
    template <int dim, typename Number>
    void
    GradientOperator<dim, Number>::apply(VectorType       &dst,
    ...
    template <int dim, typename Number>
    void
    GradientOperator<dim, Number>::apply_add(VectorType       &dst,
                                             VectorType const &src) const
    {
      matrix_free->loop(&This::cell_loop,
                        &This::face_loop,
    ...
    template <int dim, typename Number>
    void
    GradientOperator<dim, Number>::rhs(VectorType  &dst,
    ...
    template <int dim, typename Number>
    void
    GradientOperator<dim, Number>::rhs_bc_from_dof_vector(
      VectorType       &dst,
    ...
    template <int dim, typename Number>
    void
    GradientOperator<dim, Number>::evaluate_bc_from_dof_vector(
      VectorType       &dst,
    ...
    template <int dim, typename Number>
    void
    GradientOperator<dim, Number>::rhs_add(VectorType  &dst,
                                           Number const evaluation_time) const
    {
    ...
    template <int dim, typename Number>
    void
    GradientOperator<dim, Number>::evaluate_add(
      VectorType       &dst,
      VectorType const &src,
      Number const      evaluation_time) const
    {
    ...
    template <int dim, typename Number>
    void
    GradientOperator<dim, Number>::do_cell_integral_weak(
      CellIntegratorP &pressure,
      CellIntegratorU &velocity) const
    {
      for (unsigned int q = 0; q < velocity.n_q_points; ++q)
        {
          velocity.submit_divergence(kernel.get_volume_flux_weak(pressure, q),
                                     q);
        }
    }
    ...
    template <int dim, typename Number>
    void
    GradientOperator<dim, Number>::do_cell_integral_strong(
      CellIntegratorP &pressure,
      CellIntegratorU &velocity) const
    {
      for (unsigned int q = 0; q < velocity.n_q_points; ++q)
    ...
    template <int dim, typename Number>
    void
    GradientOperator<dim, Number>::do_face_integral(
      ...
      for (unsigned int q = 0; q < velocity.n_q_points; ++q)
        {
          ...
          if (data.use_boundary_data == true)
            {
              value_p =
                calculate_exterior_value(value_m,
                                         q,
                                         pressure,
                                         operator_type,
                                         boundary_type,
    ...
    template <int dim, typename Number>
    void
    GradientOperator<dim, Number>::cell_loop(
           ...
           ++cell)
        {
          ...
          if (data.integration_by_parts == true and
              data.formulation == FormulationPressureGradientTerm::Weak)
            {
              ...
              velocity.integrate_scatter(dealii::EvaluationFlags::gradients,
                                         dst);
            }
          else
            {
    ...
    template <int dim, typename Number>
    void
    GradientOperator<dim, Number>::face_loop(
      dealii::MatrixFree<dim, Number> const &matrix_free,
      VectorType                            &dst,
      VectorType const                      &src,
      ...
      if (data.integration_by_parts == true)
        {
          ...
          for (unsigned int face = face_range.first; face < face_range.second;
               face++)
            {
              ...
              velocity_m.integrate_scatter(dealii::EvaluationFlags::values,
                                           dst);
              velocity_p.integrate_scatter(dealii::EvaluationFlags::values,
                                           dst);
            }
        }
    }
    ...
    template <int dim, typename Number>
    void
    GradientOperator<dim, Number>::cell_loop_inhom_operator(
    ...
    template <int dim, typename Number>
    void
    GradientOperator<dim, Number>::face_loop_inhom_operator(
      dealii::MatrixFree<dim, Number> const &,
      VectorType &,
      VectorType const &,
      Range const &) const
      ...
      if (data.integration_by_parts == true and data.use_boundary_data == true)
        {
          ...
          FaceIntegratorP pressure(matrix_free,
                                   ...
                                   data.dof_index_pressure,
                                   data.quad_index);
          FaceIntegratorP pressure_ext(matrix_free,
                                       true,
                                       data.dof_index_pressure,
                                       data.quad_index);
          ...
          for (unsigned int face = face_range.first; face < face_range.second;
               face++)
            {
              ...
              pressure_ext.gather_evaluate(*pressure_bc,
