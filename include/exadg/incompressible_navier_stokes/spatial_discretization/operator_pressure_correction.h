...
namespace ExaDG
{
  namespace IncNS
  {
    ...
    public:
      ...
      /*
       * Initializes the inverse pressure mass matrix operator needed for the
       * pressure correction scheme, as well as the pressure mass operator
       * needed in the ALE case only (where the mass operator may be evaluated
       * at different times depending on the specific ALE formulation chosen).
       */
      void
      setup_derived() final;
       ...
       * Navier-Stokes equations (momentum equation and continuity equation).
       */
      void
      ...
      /*
       * This function applies the linearized momentum operator and is used for
      ...
      void
      interpolate_pressure_dirichlet_bc(VectorType   &dst,
                                        double const &time) const;
