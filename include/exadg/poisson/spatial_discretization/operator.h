...
namespace ExaDG
{
  namespace Poisson
  {
    ...
    private:
      ...
      // This AffineConstraints object applies homogeneous boundary conditions
      // as needed by vmult()/ apply() functions in iterative solvers for linear
      // systems of equations and preconditioners such as multigrid, implemented
      // via dealii::MatrixFree and FEEvaluation::read_dof_values() (or
      // gather_evaluate()). To deal with inhomogeneous boundary data, a
      // separate object of type AffineConstraints is needed (see below).
      ...
      // and hanging node constraints. This is only relevant for continuous
