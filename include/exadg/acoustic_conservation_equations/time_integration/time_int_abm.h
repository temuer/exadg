...
namespace ExaDG
{
  namespace Acoustics
  {
    ...
    class TimeIntAdamsBashforthMoulton
      : public TimeIntAdamsBashforthMoultonBase<
          Interface::SpatialOperator<Number>,
          dealii::LinearAlgebra::distributed::BlockVector<Number>>
    {
    public:
      TimeIntAdamsBashforthMoulton(
        std::shared_ptr<Interface::SpatialOperator<Number>> pde_operator_in,
        ...
        if (param.calculation_of_time_step_size ==
            TimeStepCalculation::UserSpecified)
          {
            initial_time_step_size =
              calculate_const_time_step(param.time_step_size,
                                        param.n_refine_time);
                 ...
                 TimeStepCalculation::CFL)
          {
            ...
            initial_time_step_size =
              cfl * this->get_underlying_operator().calculate_time_step_cfl();
