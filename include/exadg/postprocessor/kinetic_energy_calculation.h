...
namespace ExaDG
{
  struct KineticEnergyData
  {
    ...
    // perform detailed analysis and evaluate contribution of individual terms
    // (e.g., convective term, viscous term) to overall kinetic energy
    // dissipation?
  ...
  protected:
     ...
     *
     *  Kinetic energy: E_k = 1/V * 1/2 * (1,u*u)_Omega, V=(1,1)_Omega is the
     * volume
     *
     *  Enstrophy: 1/V * 0.5 (1,rot(u)*rot(u))_Omega, V=(1,1)_Omega is the
     * volume
     *
     *  Dissipation rate: epsilon = nu/V * (1, grad(u):grad(u))_Omega,
     * V=(1,1)_Omega is the volume
     *
     *  Note that
     *
