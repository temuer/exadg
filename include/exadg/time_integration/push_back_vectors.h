...
{
  /*
   * This function implements a push-back operation that is needed in multistep
   * time integration schemes like BDF schemes in order to update the solution
   * vectors from one time step to the next. The prerequisite to call this
   * function is that the type VectorType implements a swap-function!
   */
