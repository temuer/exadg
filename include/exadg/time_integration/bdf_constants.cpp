...
namespace ExaDG
{
  BDFTimeIntegratorConstants::BDFTimeIntegratorConstants(
  ...
  void
  BDFTimeIntegratorConstants::set_constant_time_step(
  ...
  void
  BDFTimeIntegratorConstants::set_adaptive_time_step(
    unsigned int const         current_order,
    ...
    switch (current_order)
      {
        ...
        case 2:
          {
            gamma0 = (2 * time_steps[0] + time_steps[1]) /
                     (time_steps[0] + time_steps[1]);
            alpha[0] = (time_steps[0] + time_steps[1]) / time_steps[1];
            alpha[1] = -time_steps[0] * time_steps[0] /
                       ((time_steps[0] + time_steps[1]) * time_steps[1]);
            break;
          }
        case 3:
          {
            gamma0 =
              1.0 + time_steps[0] / (time_steps[0] + time_steps[1]) +
            ...
            alpha[2] = +time_steps[0] * time_steps[0] *
                       (time_steps[0] + time_steps[1]) /
                       ((time_steps[0] + time_steps[1] + time_steps[2]) *
        ...
        case 4:
          {
            ...
            alpha[2] =
              time_steps[0] * time_steps[0] * (time_steps[0] + time_steps[1]) *
              (time_steps[0] + time_steps[1] + time_steps[2] + time_steps[3]) /
              ((time_steps[0] + time_steps[1] + time_steps[2]) *
