...
namespace ExaDG
{
  ABTimeIntegratorConstants::ABTimeIntegratorConstants(
    ...
    , alpha(order)
  {
    ...
    AssertThrow(
      order <= 4,
      dealii::ExcMessage(
        "Specified order of Adams-Bashforth scheme not implemented."));
  ...
  void
  ABTimeIntegratorConstants::set_constant_time_step(
  ...
  void
  ABTimeIntegratorConstants::set_adaptive_time_step(
    unsigned int const         current_order,
    ...
    switch (current_order)
      {
        ...
        case 2:
          {
            alpha[0] =
              (1.0 / 2.0 * time_steps[0] + time_steps[1]) / (time_steps[1]);
        ...
        case 3:
          {
            alpha[0] =
              1.0 + (1.0 / 3.0 * time_steps[0] * time_steps[0] +
            ...
            alpha[2] = (1.0 / 3.0 * time_steps[0] * time_steps[0] +
              ...
              (1.0 / 4.0 * time_steps[0] * time_steps[0] * time_steps[0] +
               ...
               1.0 / 2.0 * time_steps[0] *
                 (3.0 * time_steps[1] * time_steps[1] +
                  2.0 * time_steps[1] * time_steps[3] +
                  time_steps[2] * time_steps[2] +
