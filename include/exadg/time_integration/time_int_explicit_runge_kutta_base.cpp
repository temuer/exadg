...
namespace ExaDG
{
  ...
  TimeIntExplRKBase<Number>::TimeIntExplRKBase(
  ...
  template <typename Number>
  void
  TimeIntExplRKBase<Number>::set_current_time_step_size(
  ...
  TimeIntExplRKBase<Number>::setup(bool const do_restart)
  {
    ...
    if (do_restart)
      {
        // The solution vectors and the current time and the time step size have
        // to be read from restart files.
        read_restart();
      }
    else
      {
