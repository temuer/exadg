...
namespace ExaDG
{
  namespace AeroAcoustic
  {
    ...
    public:
      ...
      void
      setup(std::shared_ptr<FluidAeroAcoustic::ApplicationBase<dim, Number>>
                           application,
      ...
      {
        auto const dt = time_integrator->get_time_step_size();
        return dt * adaptive_time_stepping_limiting_factor;
      }

      void
      advance_one_timestep_and_compute_pressure_time_derivative(
        bool const update_dpdt)
      {
        ...
        // of pressure vectors that is triggered in
        ...
        if (update_dpdt)
          {
            ...
            compute_bdf_time_derivative(pressure_time_derivative,
                                        pressures,
                                        times);
          }
