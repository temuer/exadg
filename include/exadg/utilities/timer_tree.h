...
namespace ExaDG
{
  ...
  public:
     ...
     */
    void
    print_level(dealii::ConditionalOStream const &pcout,
  ...
  private:
     ...
     * pointers to data and to sub-trees still point to the original tree
     * "other".
     */
    void
     ...
     * item of the tree, in order to ensure a nice formatting when printing the
     * tree.
     */
    unsigned int
    get_length() const;
    ...
    /**
     * This function prints the whole tree by recursively going through all
     * sub-trees. An offset acting as an indentation is applied from one level
     * to the next in order to obtain a nice formatting when printing the tree.
     */
    void
    ...
    /**
     * This function print the name ID of the root element of the present tree.
     * The boolean parameter new_line describes whether a line-break is applied
     ...
     * printed always, while data is only printed if it is available. The
     * boolean parameter relative allows to also print the relative percentage
     * in wall-time compared to a refernce wall-time ref_time.
     */
    void
    ...
    /**
     * This function prints the direct children of the root element of the
     * current tree. Depending on the sub-trees and the data available for the
     * sub-trees, the implementation decides whether relative timings can be
     * printed and which sub-trees are printed in this case.
     */
    void
