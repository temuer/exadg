      ...
      add_parameters(dealii::ParameterHandler &prm) final
      {
        ...
        prm.enter_subsection("Application");
        {
          ...
          prm.add_parameter("BoundaryType",
                            boundary_type,
                            "Type of Neumann BC at right boundary.");
          prm.add_parameter("Force",
                            force,
                            "Value of force on right boundary.");
        }
                    ...
                    &multigrid_mappings) final
      {
        ...
        auto const lambda_create_triangulation =
          [&](dealii::Triangulation<dim, dim> &tria,
            ...
            element_length =
              this->length / (this->repetitions0 * pow(2, global_refinements));
                ...
                for (auto const &face : cell.face_indices())
                  {
                    ...
                    // right face
                    else if (std::fabs(cell.face(face)->center()(0) -
                                       this->length) < tol)
                      {
                    ...
                    // top-right edge
                                       ...
                                       this->length) < element_length and
                                       ...
                                       this->height / 2) < tol)
                      {
                        if (boundary_type == BoundaryType::SingleForce)
                          ...
                          {
                            AssertThrow(boundary_type ==
                                          BoundaryType::BendingMoment,
        ...
        if (boundary_type == BoundaryType::BendingMoment)
          {
            this->boundary_descriptor->neumann_bc.insert(
              pair(2,
                   new BendingMoment<dim>(force, height, incremental_loading)));
          }
