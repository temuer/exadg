    ...
    private:
                    ...
                    &multigrid_mappings) final
      {
        auto const lambda_create_triangulation = [&](
          ...
          // periodic boundary conditions are currently not available in deal.II
          // for simplex meshes
      ...
      {
        // periodic boundary conditions are currently not available in deal.II
        // for simplex meshes. Hence, we set homogeneous Dirichlet boundary
        // conditions in case of simplex meshes
        if (this->param.grid.element_type == ElementType::Simplex)
          {
