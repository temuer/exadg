  ...
  namespace IncNS
  {
    ...
    public:
      ...
      setup(Operator const &pde_operator) final
      {
        ...
        if (pp_data_bfs.turb_ch_data.time_control_data_statistics
              .time_control_data.is_active)
          {
            statistics_turb_ch.reset(new StatisticsManager<dim, Number>(
              pde_operator.get_dof_handler_u(), *pde_operator.get_mapping()));
        ...
        if (pp_data_bfs.inflow_data.write_inflow_data)
          {
            inflow_data_calculator.reset(
              new InflowDataCalculator<dim, Number>(pp_data_bfs.inflow_data,
                                                    this->mpi_comm));
        ...
        if (pp_data_bfs.line_plot_data.time_control_data_statistics
              .time_control_data.is_active)
          {
            line_plot_calculator_statistics.reset(
              new LinePlotCalculatorStatisticsHomogeneous<dim, Number>(
