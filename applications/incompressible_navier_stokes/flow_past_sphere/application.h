  ...
  namespace IncNS
  {
    ...
    public:
      ...
      add_parameters(dealii::ParameterHandler &prm) final
      {
        ...
        prm.enter_subsection("Application");
        {
          ...
          prm.add_parameter("Viscosity",
                            viscosity,
                            "Fluid viscosity.",
                            dealii::Patterns::Double(0.0, 1e30),
                            false);
        }
      ...
      set_parameters() final
      {
        ...
        this->param.multigrid_data_pressure_poisson.p_sequence =
          PSequenceType::Bisect;
