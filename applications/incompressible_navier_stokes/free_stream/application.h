...
namespace ExaDG
{
  ...
  {
    template <int dim>
    class AnalyticalSolutionVelocity
      : public dealii::Functions::ConstantFunction<dim>
    {
    public:
      AnalyticalSolutionVelocity()
        : dealii::Functions::ConstantFunction<dim>(1.0, dim)
      {}
    };

    template <int dim>
    class AnalyticalSolutionPressure
      : public dealii::Functions::ConstantFunction<dim>
    {
    public:
      AnalyticalSolutionPressure()
        : dealii::Functions::ConstantFunction<dim>(1.0, 1)
      {}
    };
    ...
    private:
      ...
      set_parameters() final
      {
        ...
        this->param.gradp_formulation =
          FormulationPressureGradientTerm::Strong; // TODO //Weak;
        this->param.divu_formulation =
          FormulationVelocityDivergenceTerm::Strong; // TODO //Weak;
        ...
        if (this->param.temporal_discretization ==
            TemporalDiscretization::BDFPressureCorrection)
          {
            ...
            this->param.newton_solver_data_momentum =
              Newton::SolverData(100, 1.e-12, 1.e-12);
