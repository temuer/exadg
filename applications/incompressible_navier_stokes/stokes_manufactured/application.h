...
namespace ExaDG
{
  namespace IncNS
  {
    ...
    // For this analysis one has to use the BDF1 scheme and homogeneous boundary
    // conditions!!!
    ...
    {
    public:
      AnalyticalSolutionVelocity(double const nu)
    ...
    {
    public:
      AnalyticalSolutionPressure(double const nu)
    ...
    private:
      ...
      set_parameters() final
      {
        ...
        this->param.adjust_pressure_level = AdjustPressureLevel::
          ApplyZeroMeanValue; // ApplyAnalyticalSolutionInPoint;
