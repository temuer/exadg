    ...
    namespace SquareCylinder
    {
                       ...
                       ElementType               element_type)
      {
        ...
        create_subdivided_hyper_rectangle(
          tmp, ref, x_0, x_1, element_type, false);
      ...
      do_create_coarse_triangulation(dealii::Triangulation<2> &triangulation,
                                     ...
                                     bool                      is_2d = true)
      {
        dealii::Triangulation<2>::MeshSmoothing const mesh_smoothing =
          ...
          case CylinderType::Circular:
            {
              ...
              CircularCylinder::create_coarse_triangulation<dim>(
                triangulation, periodic_faces);
              break;
            }
