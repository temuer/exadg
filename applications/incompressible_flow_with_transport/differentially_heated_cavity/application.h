  ...
  namespace FTI
  {
    ...
    private:
                ...
                for (auto const &f : cell->face_indices())
                  {
                    ...
                    if ((std::fabs(cell->face(f)->center()(1) - left) <
                         1e-12) or
      ...
      create_mesh_movement_function() final
      {
        ...
        data.shape =
          MeshMovementShape::SineAligned; // SineZeroAtBoundary; //SineAligned;
    ...
    private:
      ...
      set_boundary_descriptor() final
      {
        ...
        this->boundary_descriptor->dirichlet_bc.insert(
          pair(1,
               new dealii::Functions::ConstantFunction<dim>(T_ref + delta_T)));
