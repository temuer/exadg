...
namespace dealii
{
  namespace GridGenerator
  {
      ...
      if (dim == 3)
        {
          ...
          Point<dim> const dx((p2[0] - p1[0]) / repetitions[0],
                     ...
                     unsigned int const            face_no = 1)
    {
      ...
      unsigned int const coordinate = face_no / 2;
#ifdef DEBUG
    ...
    mixed_3d_mesh(Triangulation<dim, spacedim> &tria,
                  unsigned int const            n_repetitions = 3,
                  bool const                    include_wedge = false)
    {
      ...
      GridGenerator::replicate_triangulation(tria_cube_repeated,
                                             {{n_extensions, 1, 1}},
                                             tria_cube);
      ...
      GridGenerator::replicate_triangulation(tria_temp,
                                             {{n_extensions, 1, 1}},
                                             tria_temp_repeated);
      GridGenerator::convert_hypercube_to_simplex_mesh(tria_temp_repeated,
                                                       tria_simplex);
      ...
      if (include_wedge)
        {
          ...
          GridGenerator::merge_triangulations(tria_cube,
                                              tria_h_2_s,
                                              tria_temp_2);
          GridGenerator::merge_triangulations(tria_temp_2,
                                              tria_simplex,
                                              tria_temp_3);
          GridGenerator::merge_triangulations(tria_temp_3,
                                              tria_wedge,
                                              tria_temp_4);
          GridGenerator::replicate_triangulation(
            tria_temp_4, {{1, n_extensions, n_extensions}}, tria);
        }
      else
        {
          ...
          GridGenerator::merge_triangulations(tria_temp_2,
                                              ...
                                              tria_temp_3);
          GridGenerator::replicate_triangulation(
            tria_temp_3, {{1, n_extensions, n_extensions}}, tria);
        }
    }
  } // namespace GridGenerator
} // namespace dealii
